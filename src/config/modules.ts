...
export const GAME_MODULES: readonly GameModuleDefinition[] = [
  ...
  { id: "dealership", label: "4S店", shortLabel: "4S店", icon: "store", status: "reserved", featureFlag: "dealership", group: "expansion" },
  { id: "used-vehicles", label: "二手车市场", shortLabel: "二手车", icon: "used", status: "reserved", featureFlag: "usedVehicleMarket", group: "expansion" },
